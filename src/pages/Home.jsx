...
const quickActions = [
  { title: 'Chat anónimo', description: 'Habla sin dar tu nombre', to: '/chat/anonimo', illustration: 'chat' },
  { title: 'Pedir una cita', description: 'Encuentra apoyo profesional', to: '/ayuda/cita', illustration: 'appointment' },
  { title: 'Consejos', description: 'Ideas para sentirte acompañado/a', to: '/ayuda/consejos', illustration: 'advice' },
  { title: 'Reportar', description: 'Cuenta una situación de forma segura', to: '/reportar', illustration: 'report' },
  { title: 'Encuesta', description: 'Comparte cómo fue tu experiencia', to: '/encuesta', illustration: 'survey' },
]
